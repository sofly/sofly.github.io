...
const LEFT_EYE_HOLE = [
  130, 113, 124, 156, 70, 63, 105, 66, 107, 55, 221, 189, 244, 243, 112, 26, 22, 23, 24, 110, 25,
];
const RIGHT_EYE_HOLE = [
  359, 255, 339, 254, 253, 252, 256, 341, 463, 464, 413, 441, 285, 336, 296, 334, 293, 300, 383,
  353, 342,
];
const NOSE_HOLE = [
  166, 60, 99, 97, 2, 326, 328, 290, 392, 309, 458, 461, 354, 19, 125, 241, 238, 79,
];
